...
- **На сервере:** Вероятно, миграции поддержки уже выполнены
- **Решение:** Создана миграция для удаления таблиц поддержки
...
Выполните миграцию для удаления таблиц:
...
- Удалит `ticket_chats`
- Удалит колонку `chat_id` из `support_tickets` (если существует)
