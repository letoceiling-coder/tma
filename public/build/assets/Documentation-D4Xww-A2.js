import{_ as s,c as o,a as i,F as a,q as d,o as r,p as c,t as g}from"./admin-D73EZYWO.js";const u={name:"Documentation",data(){return{activeSection:"database",sections:[{id:"database",title:"База данных"},{id:"api",title:"API Endpoints"},{id:"admin",title:"Админ-панель"},{id:"frontend",title:"Frontend"},{id:"telegram",title:"Telegram интеграция"},{id:"notifications",title:"Уведомления"},{id:"commands",title:"Команды"}],documentation:{database:`
...
Schedule::command('wow:send-reminders')
    ...
    ->runInBackground();</code></pre>
                ...
                `}}},computed:{currentContent(){return this.documentation[this.activeSection]||"<p>Раздел в разработке</p>"}}},p={class:"documentation-page"},h={class:"space-y-6"},m={class:"bg-card rounded-lg border border-border p-4"},_={class:"flex flex-wrap gap-2"},b=["onClick"],f={class:"bg-card rounded-lg border border-border p-6"},T=["innerHTML"];function w(v,e,k,y,t,n){return r(),o("div",p,[e[1]||(e[1]=i("div",{class:"mb-6"},[i("h1",{class:"text-2xl font-bold text-foreground"},"Документация"),i("p",{class:"text-muted-foreground mt-1"},"Техническая документация по системе WOW Рулетка")],-1)),i("div",h,[i("div",m,[e[0]||(e[0]=i("h2",{class:"text-lg font-semibold mb-4"},"Разделы документации",-1)),i("nav",_,[(r(!0),o(a,null,d(t.sections,l=>(r(),o("button",{key:l.id,onClick:x=>t.activeSection=l.id,class:c(["px-4 py-2 rounded-lg text-sm font-medium transition-colors",t.activeSection===l.id?"bg-primary text-primary-foreground":"bg-muted text-muted-foreground hover:bg-muted/80"])},g(l.title),11,b))),128))])]),i("div",f,[i("div",{innerHTML:n.currentContent,class:"prose prose-sm max-w-none dark:prose-invert"},null,8,T)])])])}const E=s(u,[["render",w],["__scopeId","data-v-fb11a9db"]]);export{E as default};
